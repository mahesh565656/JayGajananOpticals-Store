<footer>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                     ...
                     <ul>
                        ...
                        <li>
                            <a href="mailto:hello@domain.com"><i class="fa fa-envelope"></i> jaygajananopticals@gmail.com</a>
                         </li>
                     </ul>
        ...
        <p class="copyright">&copy; 2023 Jay Gajanan Opticals | Optical Store in Amravati. All rights reserved.</p>
    </footer>
