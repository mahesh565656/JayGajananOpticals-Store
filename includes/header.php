...
define("APPURL", "https://localhost/JayGajananOpticals");
        ...
        <nav class="navbar fixed-top navbar-expand-md navbar-dark bg-transparent" id="page-navigation">
            <div class="container">
                ...
                <a href="index.php" class="navbar-brand">
                    <h5 style="font-style:inherit;">Shree Gajanan Opticals</h5>
                  <!--  <img src="<?php echo APPURL; ?>/assets/img/logo/sponsor.png" alt="">-->
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <?php if (!isset($_SESSION["username"])) : ?>
                            <li class="nav-item">
                                <a href="<?php echo APPURL; ?>/register.php" class="nav-link">Register</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo APPURL; ?>/login.php" class="nav-link">Login</a>
                            </li>
                        <?php else : ?>
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="<?php echo APPURL; ?>/logout.php">Log Out</a>
                                </div>
                            </li>
                            <li class="nav-item">
